(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-intl'), require('react-dom'), require('classnames'), require('react-modal'), require('no-scroll'), require('react-responsive'), require('date-fns')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-intl', 'react-dom', 'classnames', 'react-modal', 'no-scroll', 'react-responsive', 'date-fns'], factory) :
  (global = global || self, factory(global.Alma = {}, global.react, global.reactIntl, global.reactDom, global.classnames, global.reactModal, global.noScroll, global.reactResponsive, global.dateFns));
}(this, (function (exports, React, reactIntl, reactDom, cx, Modal, noScroll, reactResponsive, dateFns) {
  ...
  noScroll = noScroll && Object.prototype.hasOwnProperty.call(noScroll, 'default') ? noScroll['default'] : noScroll;
