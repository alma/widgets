...
interface PaymentPlanTemplates extends BaseTemplateSettings {
    planSummary?: ((planProperties: QueriedPlanProperties, results: IEligibility[]) => DOMContent) | null;
}
export declare type QueriedPlanProperties = {
...
export interface PaymentPlanSettings extends BaseWidgetSettings<PaymentPlanTemplates, BaseClassesSettings> {
