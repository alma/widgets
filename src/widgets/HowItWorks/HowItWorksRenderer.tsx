...
export function HowItWorksRenderer({ samplePlans, closeCallback }: HowItWorksProps): JSX.Element {
  ...
  return (
    <Modal closeCallback={closeCallback}>
      <div className="atw-overflow-auto alma-text atw-relative atw-flex atw-flex-row atw-flex-wrap atw-rounded-sm atw-shadow-lg atw-w-screen atw-h-screen md:atw-h-650 lg:atw-w-9/12 md:atw-max-w-3xl atw-max-h-screen atw-bg-white">
        <button
